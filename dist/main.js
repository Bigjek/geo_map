...
var listI = __webpack_require__(75);
var myMap = void 0,
    clusterer = void 0,
    myPlacemark = [],
    myList = { list: [] },
...
var myModuleMap = {
    ...
    myMapSearch: function myMapSearch() {
    ...
    loadMap: function loadMap() {
        ...
        return new _promise2.default(function (resolve) {
            ...
            '<strong class=ballon_header>{{ properties.address|raw }}</strong></br>' + '<div class=ballon_body><a href="#" class="ballon_click">{{ properties.iconCaption|raw }}</a></br>{{ properties.description|raw }}</div>' + '<div class=ballon_footer>{{ properties.balloonContentFooter|raw }}</div>');
    ...
    getValueForm: function getValueForm() {
    ...
    removeValueForm: function removeValueForm() {
    ...
    newAddressForm: function newAddressForm(e) {
